...
describe("OptionsTestVault Contract", function () {
  ...
  before(async function () {
    ...
    console.log("Before Balance eth of impersonatedSigner %s", await ethers.provider.getBalance(impersonatedSigner));
    const tx = {
    ...
    console.log("Balance eth of impersonatedSigner %s", await ethers.provider.getBalance(impersonatedSigner));
  ...
  it("should deposit tokens to AEVO directly", async function () {
    ...
    console.log("eth Balance eth of user %s", await ethers.provider.getBalance(user));
    console.log("usdc.e Balance eth of user %s", await bridgedUsdc.connect(user).balanceOf(optionsReceiver));
